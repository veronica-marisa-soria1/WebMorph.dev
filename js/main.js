// Todo el archivo va dentro de un IIFE para no dejar ~30 variables en el
// scope global. Se usa IIFE y no type="module" porque un módulo no carga
// por file://, y el proyecto se abre así durante el desarrollo.
(() => {
  "use strict";
